...
//  SketchPal
//
//  Created by Ali Mohammadian on 12/30/16.
...
class ViewController: UIViewController, GADBannerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-7340562758794459/6171384120"
    ...
    @IBAction func save(_ sender: AnyObject) {
        ...
        let actionSheet = UIAlertController(title: "Choose an option", message: "",
        ...
        actionSheet.addAction(UIAlertAction(title: "Save your image", style: .default, handler: { (_) in
    ...
    @IBAction func colorsPicked(_ sender: AnyObject) {
        if sender.tag == 0 {
            ...
            (red, green, blue) = (0.6, 0.8, 1)
        } else if sender.tag == 2 {
            (red, green, blue) = (0.4, 0.4, 0.4)
        } else if sender.tag == 3 {
            (red, green, blue) = (0.6, 1, 0.4)
            ...
            (red, green, blue) = (0.4, 0.2, 0)
        } else if sender.tag == 9 {
            (red, green, blue) = (0, 0.4, 0.2)
        } else if sender.tag == 10 {
            (red, green, blue) = (1, 0.2, 0.4)
        } else if sender.tag == 11 {
            (red, green, blue) = (1, 0.6, 0)
        } else if sender.tag == 12 {
            (red, green, blue) = (1, 0.6, 0.6)
        } else if sender.tag == 13 {
            (red, green, blue) = (0.8, 0.2, 1)
        }
    }
